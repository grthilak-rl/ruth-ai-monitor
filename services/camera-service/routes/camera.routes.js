...
// AI Model subscription management routes
router.post('/:id/models/:modelId/subscribe', cameraIdValidation, cameraController.subscribeCameraModel);
router.post('/:id/models/:modelId/unsubscribe', cameraIdValidation, cameraController.unsubscribeCameraModel);
router.get('/:id/models/:modelId/status', cameraIdValidation, cameraController.getCameraModelStatus);

// AI Model violation reporting
router.post('/:id/violations', cameraIdValidation, cameraController.saveModelViolation);
